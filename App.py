...
:root {
  --gold: #FFE600;
  --gold-dim: rgba(255,230,0,0.18);
  --gold-glow: rgba(255,230,0,0.10);
  --bg: #ffffff;
  --surface: #f8f8f8;
  --surface2: #eeeeee;
  --border: var(--text);
...
.ey-wordmark span { color: var(--text-muted); font-weight: 500; font-size: 15px; letter-spacing: 0.2px; vertical-align: middle; }
...
div[data-testid="stFileUploader"] label { color: var(--text) !important; font-weight: 600 !important; font-size: 14px !important; }
/* The inner drag-drop zone */
...
div[data-testid="stFileUploader"] div { color: var(--text) !important; }
/* The SVG cloud upload icon */
...
div[data-testid="stFileUploader"] [data-testid="stFileUploaderDeleteBtn"] { color: var(--text-muted) !important; }
...
div[data-baseweb="menu"] { background: #ffffff !important; border: 1px solid var(--border) !important; border-radius: 8px !important; box-shadow: 0 4px 20px rgba(0,0,0,0.10) !important; }
li[role="option"] { background: #ffffff !important; color: var(--text) !important; }
li[role="option"]:hover { background: #f5f0c0 !important; }
li[role="option"][aria-selected="true"] { background: rgba(255,230,0,0.20) !important; }
button[kind="primary"],
.stButton > button {
...
/* ── Download buttons same as primary ── */
...
div[data-testid="stTextArea"] textarea::placeholder { color: #aaaaaa !important; opacity: 1 !important; }
div[data-testid="stTextArea"] label { color: var(--text) !important; font-weight: 600 !important; }

/* ── EXPANDERS — full white interior ── */
...
div[data-testid="stExpander"] summary span { color: var(--text) !important; font-weight: 600 !important; }
div[data-testid="stExpander"] > div > div { background: #ffffff !important; }
/* Content inside expanded expander */
...
div[data-testid="stRadio"] span { color: var(--text) !important; }
...
/* ── ACCEPT CHOSEN VALUE button — always visible, not just on hover ── */
.stButton > button {
  color: #1a1a1a !important;
}

/* ── RAW JSON light mode ── */
.stCodeBlock > div, div[data-testid="stCode"] > div {
  background: #f5f5f5 !important;
  border: 1px solid var(--border) !important;
  border-radius: 8px !important;
}
.stCodeBlock code, div[data-testid="stCode"] code { color: #1a1a1a !important; background: transparent !important; }
pre { background: #f5f5f5 !important; color: #1a1a1a !important; border: 1px solid var(--border) !important; border-radius: 8px !important; }
code { background: #f0f0f0 !important; color: #1a1a1a !important; }
...
.token.property { color: #1a1a1a !important; font-weight: 600; }
...
div[data-testid="stTextInput"] label { color: var(--text) !important; font-weight: 600 !important; }
div[data-testid="stTextInput"] input:focus:placeholder-shown {
  border-color: #d4a800 !important;
  box-shadow: 0 0 0 2px rgba(255,230,0,0.22) !important;
        ...
        <div class="card" style="height:100%;padding:22px 24px;">
          ...
          <div style="display:flex;gap:16px;align-items:flex-start;">
            <div style="display:flex;flex-direction:column;align-items:center;flex-shrink:0;">
              <div style="width:34px;height:34px;background:var(--gold-dim);border:1px solid rgba(255,230,0,0.3);
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#888888" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
                  <line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/>
                </svg>
              </div>
              <div style="width:1px;height:28px;background:linear-gradient(to bottom,rgba(0,0,0,0.12),transparent);margin-top:4px;"></div>
            </div>
          ...
          <div style="display:flex;gap:16px;align-items:flex-start;">
            <div style="display:flex;flex-direction:column;align-items:center;flex-shrink:0;">
              ...
              <div style="width:1px;height:28px;background:linear-gradient(to bottom,rgba(0,0,0,0.06),transparent);margin-top:4px;"></div>
            </div>
            ...
            with content_ph.container():
                ...
                if ct == "auto":
                    if nda and sow:
                        ...
                        detected_icon  = "🔍"
                        banner_color   = "#1a1a1a"
                        glow_color     = "rgba(255,230,0,0.22)"
                        border_color   = "rgba(212,168,0,0.55)"
                    elif nda:
